...
public class TestResultsAnalyzer : ITestResultsAnalyzer
{
        ...
        string className)
    {
        ...
        {
            // Escape quotes by doubling them for CLI argument handling
            // Shell (CLI) interprets "" as escaped quote inside quoted strings
            // Example: MethodName("param1","param2") becomes MethodName(""param1"",""param2"")
